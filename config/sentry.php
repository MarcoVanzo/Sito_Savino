...
return [
    ...
    // 0.1 = una transazione su dieci. Il piano gratuito ha una quota mensile di
    // performance units piuttosto bassa: campionare tutto la esaurirebbe in pochi
    // giorni e Sentry inizierebbe a scartare ANCHE gli errori. Gli errori non sono
    // campionati (`sample_rate` resta 1.0): questa voce riguarda solo il tracing.
    ...
    // Deve restare `false`. Con `true` Sentry allega corpo della richiesta,
    // cookie e IP: sul checkout significherebbe spedire indirizzi di spedizione
    // e dati dei clienti a un servizio terzo, senza base giuridica per farlo.
    'send_default_pii' => env('SENTRY_SEND_DEFAULT_PII', false),

    // @see: https://docs.sentry.io/platforms/php/guides/laravel/configuration/options/#ignore_exceptions
    //
    // Rumore, non guasti: sono tutte eccezioni che rappresentano un input
    // sbagliato dell'utente, non un difetto del codice. Lasciarle passare
    // riempirebbe Sentry di 404 dei crawler e di form compilati male, fino a
    // rendere invisibili gli errori veri (ed esaurire la quota del piano).
    'ignore_exceptions' => [
        ...
        // Rate limiting: è la difesa che funziona, non un errore.
        ThrottleRequestsException::class,
    ],

    // @see: https://docs.sentry.io/platforms/php/guides/laravel/configuration/options/#ignore_transactions
    'ignore_transactions' => [
        // L'health check di App Platform gira di continuo: come transazione è
        // solo rumore che consuma quota.
        '/up',
    ],
