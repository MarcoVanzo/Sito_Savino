...
/**
 * Le tappe fondamentali della societa: unica fonte di verita per il seeder
 * delle pagine CMS e per la migrazione che le ripristina se mancano in tabella.
 * A regime si modificano dal pannello (Pagine > Storia > Tappe Fondamentali).
 */
return [
    'it' => [
        0 => [
