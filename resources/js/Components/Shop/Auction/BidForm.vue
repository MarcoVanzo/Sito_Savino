...
<template>
    <div class="bg-gray-800/50 rounded-xl p-5 border border-gray-700/50">
        ...
        <div v-if="!user" class="text-center py-4">
            ...
            <a
                :href="route('login')"
                class="inline-flex items-center gap-2 bg-savino-fucsia text-white font-bold text-sm uppercase tracking-wider px-6 py-3 rounded-lg hover:bg-savino-fucsia/90 transition-all duration-300"
            >
        ...
        <div v-else>
            ...
            <form @submit.prevent="submitBid" class="space-y-3">
                ...
                <button
                    ...
                    class="w-full bg-savino-fucsia text-white font-black text-sm uppercase tracking-wider py-4 rounded-lg hover:bg-savino-fucsia/90 transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                >
