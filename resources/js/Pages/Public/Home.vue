    ...
    <PublicLayout>
        ...
        <div class="hero-wrapper relative w-full min-h-screen flex items-center bg-gray-900 overflow-hidden">
            ...
            <div class="absolute inset-0 z-[3]">
                ...
                <div class="absolute inset-0 bg-gradient-to-r from-gray-900/35 via-gray-900/10 to-transparent"></div>
        ...
        <section ref="statsSection" class="relative py-28 overflow-hidden" style="background: linear-gradient(155deg, #001028 0%, #002244 30%, #003063 55%, #001d3d 80%, #000d1f 100%);">
            ...
            <div class="absolute inset-0" style="background: radial-gradient(ellipse at 50% 40%, rgba(201,168,76,0.04) 0%, transparent 60%);"></div>
            <!-- Subtle noise texture for material depth -->
...
@media (min-width: 768px) {
    .stats-grid .stat-column {
        position: relative;
    }
    .stats-grid .stat-column:not(:last-child)::after {
        content: '';
        position: absolute;
        right: 0;
        top: 15%;
