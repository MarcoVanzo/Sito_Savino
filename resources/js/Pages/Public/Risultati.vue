...
const displayGames = props.games.length > 0 ? props.games : placeholderGames
const displayStandings = props.standings.length > 0 ? props.standings : placeholderStandings
...
<template>
    <Head :title="page?.title ?? 'Risultati e Classifica'" />
    ...
    <PublicLayout>
        ...
        <section class="relative min-h-[40vh] flex items-center justify-center overflow-hidden">
            ...
            <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
                ...
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-black text-white uppercase tracking-tighter mt-4" style="font-family: 'Montserrat', sans-serif;">{{ page?.title ?? 'Risultati e Classifica' }}</h1>
                <div class="w-16 h-1 bg-savino-gold mx-auto mt-4 mb-6"></div>
                <p class="text-white/70 text-lg max-w-2xl mx-auto" style="font-family: 'Montserrat', sans-serif;">Segui i risultati delle nostre partite e la classifica aggiornata del campionato.</p>
            </div>
        </section>
        ...
        <section class="py-16 bg-gray-50">
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 class="text-3xl font-black text-gray-900 uppercase tracking-tight mb-2" style="font-family: 'Montserrat', sans-serif;">Ultime Partite</h2>
                    ...
                    >
                        <div class="flex items-center">
                            ...
                            <div class="w-28 sm:w-32 flex-shrink-0 bg-savino-blue text-white text-center py-5 px-3">
                                <span class="text-xs font-bold uppercase tracking-wider block" style="font-family: 'Montserrat', sans-serif;">{{ game.date }}</span>
                                <span class="text-[10px] text-white/60 mt-1 block" style="font-family: 'Montserrat', sans-serif;">{{ game.status }}</span>
                            </div>
                            <!-- Match -->
                            <div class="flex-1 flex items-center justify-between px-4 sm:px-8 py-4">
                                ...
                                <div class="flex items-center gap-2 flex-shrink-0">
                                    <span class="text-2xl font-black text-gray-900" style="font-family: 'Montserrat', sans-serif;">{{ game.scoreHome }}</span>
                                    <span class="text-gray-400 text-lg">-</span>
                                    <span class="text-2xl font-black text-gray-900" style="font-family: 'Montserrat', sans-serif;">{{ game.scoreAway }}</span>
                                </div>
        ...
        <section class="py-16 bg-white">
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 class="text-3xl font-black text-gray-900 uppercase tracking-tight mb-2" style="font-family: 'Montserrat', sans-serif;">Classifica</h2>
                <div class="w-12 h-1 bg-savino-gold mb-10"></div>

                <div class="overflow-x-auto rounded-xl shadow-lg border border-gray-100">
                    <table class="w-full text-left" style="font-family: 'Montserrat', sans-serif;">
                        <thead>
                ...
                <p class="text-xs text-gray-400 mt-4 text-center" style="font-family: 'Montserrat', sans-serif;">G = Giocate · V = Vinte · P = Perse · SV = Set Vinti · SP = Set Persi</p>
            </div>
        </section>
    </PublicLayout>
</template>
