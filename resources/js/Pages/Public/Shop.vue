    ...
    <PublicLayout>
        ...
        <section class="relative min-h-[40vh] flex items-center justify-center overflow-hidden">
            ...
            <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
                <span class="text-savino-gold text-sm font-bold uppercase tracking-[0.3em]" style="font-family: 'Montserrat', sans-serif;">Merchandise Ufficiale</span>
            ...
            <div class="max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <div class="relative aspect-square bg-gray-50 overflow-hidden">
                            ...
                            <div class="absolute inset-0 bg-savino-blue/80 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                                <span class="text-white text-sm font-bold uppercase tracking-wider border-2 border-savino-gold px-6 py-3 hover:bg-savino-gold hover:text-savino-blue transition-colors" style="font-family: 'Montserrat', sans-serif;">Dettagli</span>
                            </div>
                        </div>

                        <!-- Product Info -->
                        <div class="p-5">
                            <h3 class="text-savino-blue font-bold text-lg mb-2 group-hover:text-savino-gold transition-colors" style="font-family: 'Montserrat', sans-serif;">
                                {{ product.name }}
                            </h3>
                            <p class="text-savino-red font-black text-xl" style="font-family: 'Montserrat', sans-serif;">
                ...
                <div v-else class="text-center py-20">
                    <div class="max-w-lg mx-auto">
                        ...
                        <h2 class="text-3xl md:text-4xl font-black text-savino-blue uppercase tracking-tighter mb-4" style="font-family: 'Montserrat', sans-serif;">
                            Negozio in Arrivo
                        </h2>
                        <div class="w-16 h-1 bg-savino-gold mx-auto mb-6"></div>
                        <p class="text-gray-600 text-lg leading-relaxed mb-8" style="font-family: 'Montserrat', sans-serif;">
                        ...
                        <div class="inline-flex items-center gap-3 bg-savino-blue/5 border border-savino-blue/10 rounded-full px-8 py-4">
                            ...
                            <span class="text-savino-blue text-sm font-bold uppercase tracking-wider" style="font-family: 'Montserrat', sans-serif;">Prossimamente</span>
                        </div>
                    </div>
                </div>
            </div>
