                    ...
                    <div>
                        ...
                        <div class="relative aspect-square bg-gray-800 rounded-2xl overflow-hidden mb-4">
                            ...
                            <div class="absolute top-4 left-4 flex gap-2">
                                ...
                                <span v-if="currentAuction.is_charity" class="bg-savino-fucsia/20 text-savino-fucsia-chiaro border border-savino-fucsia/30 text-xs font-black uppercase tracking-wider px-3 py-1.5 rounded-full backdrop-blur-sm">
                                    🎗️ Charity
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="bg-gray-800/50 rounded-xl p-5 mb-5 border border-gray-700/50">
                            ...
                            <div class="flex items-end gap-3">
                                <span class="text-savino-fucsia-chiaro font-black text-4xl sm:text-5xl tabular-nums">
                        ...
                        >
                            <p class="text-savino-fucsia-chiaro font-bold text-lg mb-3">🎉 {{ $t('auction.ended_badge') || 'Asta conclusa!' }}</p>
                        </div>
                ...
                <div class="mt-12 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                    ...
                    <div class="space-y-6">
                        ...
                        <div v-if="currentAuction.charity_description" class="bg-savino-fucsia/5 rounded-2xl p-6 border border-savino-fucsia/20">
                            <h3 class="text-savino-fucsia-chiaro font-bold text-sm uppercase tracking-wider mb-3 flex items-center gap-2">
