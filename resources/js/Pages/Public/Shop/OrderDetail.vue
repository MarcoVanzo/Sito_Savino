                            ...
                            <ul class="divide-y divide-gray-100">
                                <li v-for="item in order.items" :key="item.id" class="p-6 flex items-center gap-6">
                                    ...
                                    <div class="flex-1 flex flex-col justify-center">
                                        ...
                                        <!-- Lo stato dichiarato al momento dell'acquisto (maglie indossate, autografi) -->
                                        <p v-if="item.testo_stato_articolo" class="text-sm text-gray-700 mt-1 whitespace-pre-line"><span class="font-semibold text-savino-blue">{{ $t('shop.item_condition') }}:</span> {{ item.testo_stato_articolo }}</p>
