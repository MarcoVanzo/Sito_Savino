    ...
    <PublicLayout>
        ...
        <section class="relative min-h-[25vh] flex items-center justify-center overflow-hidden">
            ...
            <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-16">
                <span class="text-savino-fucsia-chiaro text-sm font-bold uppercase tracking-[0.3em]">{{ $t('shop_contacts.hero_label') }}</span>
            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <nav class="mb-8 text-sm">
                    <ol class="flex items-center gap-2 text-gray-500">
                        <li><Link :href="route('shop')" class="hover:text-savino-fucsia-chiaro transition-colors">{{ $t('shop_contacts.breadcrumb_shop') }}</Link></li>
                        <li>/</li>
                    ...
                    <template v-for="(card, index) in contactCards" :key="index">
                        ...
                        >
                            ...
                            <component
                                ...
                                :class="{ 'hover:text-savino-fucsia-chiaro transition-colors': card.href() }"
                            >
                                {{ card.value() }}
                            </component>
                        </div>
                ...
                <div v-if="supportNotes" class="mt-8 bg-gray-800/30 border border-gray-800 rounded-xl p-6">
                    <h3 class="text-savino-fucsia-chiaro text-xs font-bold uppercase tracking-[0.2em] mb-3">{{ $t('shop_contacts.additional_info') }}</h3>
