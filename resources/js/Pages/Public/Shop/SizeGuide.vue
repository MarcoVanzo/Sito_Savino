    ...
    <PublicLayout>
        ...
        <section class="relative min-h-[25vh] flex items-center justify-center overflow-hidden">
            ...
            <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-16">
                <span class="text-savino-fucsia text-sm font-bold uppercase tracking-[0.3em]">{{ $t('shop_size_guide.hero_label') }}</span>
            ...
            <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <nav class="mb-8 text-sm">
                    <ol class="flex items-center gap-2 text-gray-500">
                        <li><Link :href="route('shop')" class="hover:text-savino-fucsia transition-colors">{{ $t('shop_size_guide.breadcrumb_shop') }}</Link></li>
                        <li>/</li>
                    ...
                    >
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-grow min-w-0">
                                <h3 class="text-white font-bold text-sm uppercase tracking-wider truncate group-hover:text-savino-fucsia transition-colors">
                                    {{ guide.name }}
                                </h3>
                                <p class="text-gray-500 text-xs mt-1 uppercase tracking-wider">{{ $t('shop_size_guide.pdf_download') }}</p>
                            </div>
                            <svg class="w-5 h-5 text-gray-600 group-hover:text-savino-fucsia transition-colors flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div v-if="supportEmail" class="mt-12 bg-gray-800/30 border border-gray-800 rounded-xl p-6 text-center">
                    <p class="text-gray-400 text-sm">
                        ...
                        <a :href="'mailto:' + supportEmail" class="text-savino-fucsia hover:underline font-bold ml-1">
                            {{ supportEmail }}
                        </a>
                    </p>
                </div>
