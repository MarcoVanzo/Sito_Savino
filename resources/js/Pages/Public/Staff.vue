...
const ogMeta = useOgMeta({
    title: props.page?.title ?? 'Staff Tecnico e Medico',
    description: 'Lo staff tecnico e medico della Savino Del Bene Volley. Allenatori, preparatori e team di supporto.',
})
