...
<template>
    <Head :title="page?.title ?? 'Summer Camp & Experience'" />

    <!-- Hero -->
    <section class="relative min-h-[40vh] flex items-center justify-center overflow-hidden">
        <div class="absolute inset-0 bg-gradient-to-br from-gray-900 via-savino-blue to-gray-900"></div>
        <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
            <span class="text-savino-gold text-sm font-bold uppercase tracking-[0.3em]" style="font-family: 'Montserrat', sans-serif;">Estate di Sport</span>
            ...
            <p class="text-white/70 text-lg max-w-2xl mx-auto" style="font-family: 'Montserrat', sans-serif;">
                Un'estate indimenticabile tra sport, divertimento e crescita personale.
            </p>
        </div>
    </section>
    ...
    <section class="py-20 bg-white">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div>
                    <span class="text-savino-gold text-sm font-bold uppercase tracking-[0.2em]" style="font-family: 'Montserrat', sans-serif;">Il Camp</span>
                    ...
                    <p class="text-gray-600 leading-relaxed mb-4" style="font-family: 'Montserrat', sans-serif;">
                        Il Summer Camp della Savino Del Bene è un'esperienza unica pensata per ragazze e ragazzi dai 6 ai 16 anni.
                        Un programma completo che unisce la passione per la pallavolo ad attività ricreative e formative.
                    </p>
                    <p class="text-gray-600 leading-relaxed mb-6" style="font-family: 'Montserrat', sans-serif;">
                        I nostri istruttori qualificati seguiranno ogni partecipante in un percorso di crescita sportiva e personale,
                        in un ambiente sicuro e stimolante.
                    </p>
                    <ul class="space-y-3">
                        <li v-for="item in ['Staff tecnico qualificato', 'Gruppi per fasce d\'età', 'Assicurazione inclusa', 'Pranzo e merenda inclusi']" :key="item" class="flex items-center gap-3">
                            ...
                            <span class="text-gray-700 text-sm" style="font-family: 'Montserrat', sans-serif;">{{ item }}</span>
                        </li>
                    </ul>
                </div>
                <div class="bg-gradient-to-br from-savino-blue/10 to-savino-gold/10 rounded-2xl p-8 flex items-center justify-center min-h-[300px]">
                    <div class="text-center">
                        ...
                        <p class="text-savino-blue font-bold mt-4 text-lg" style="font-family: 'Montserrat', sans-serif;">Summer Camp 2026</p>
                        <p class="text-gray-500 text-sm mt-1" style="font-family: 'Montserrat', sans-serif;">Edizione speciale</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-20 bg-gray-50">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <span class="text-savino-gold text-sm font-bold uppercase tracking-[0.2em]" style="font-family: 'Montserrat', sans-serif;">Programma</span>
                <h2 class="text-3xl md:text-4xl font-black text-gray-900 uppercase tracking-tight mt-2" style="font-family: 'Montserrat', sans-serif;">
                    Le Nostre Attività
                </h2>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                >
                    ...
                    <h3 class="text-lg font-bold text-gray-900 mb-2" style="font-family: 'Montserrat', sans-serif;">
                        {{ activity.title }}
                    </h3>
    ...
    <section class="py-20 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <span class="text-savino-gold text-sm font-bold uppercase tracking-[0.2em]" style="font-family: 'Montserrat', sans-serif;">Calendario</span>
                <h2 class="text-3xl md:text-4xl font-black text-gray-900 uppercase tracking-tight mt-2" style="font-family: 'Montserrat', sans-serif;">
                    Date e Turni
                </h2>
                <div class="w-12 h-1 bg-savino-gold mx-auto mt-4"></div>
            ...
            <div class="space-y-4">
                ...
                >
                    <div class="flex items-center gap-4 mb-3 sm:mb-0">
                        <span class="w-10 h-10 rounded-full bg-savino-blue/10 flex items-center justify-center text-savino-blue font-bold text-sm" style="font-family: 'Montserrat', sans-serif;">
                            {{ index + 1 }}
                        </span>
                        <div>
                            <h4 class="font-bold text-gray-900" style="font-family: 'Montserrat', sans-serif;">{{ dateInfo.period }}</h4>
                            <p class="text-gray-500 text-sm" style="font-family: 'Montserrat', sans-serif;">{{ dateInfo.dates }}</p>
                        </div>
                    </div>
                    <span
            ...
            <div class="text-center mt-12">
                <a href="#" class="inline-flex items-center gap-2 bg-savino-gold text-white font-bold uppercase tracking-wider text-sm px-8 py-4 rounded-lg hover:bg-savino-gold/90 transition-colors" style="font-family: 'Montserrat', sans-serif;">
                    Iscriviti Ora
