            ...
            <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
                ...
                <div v-if="ticketsUrl" class="mt-10">
                    <a
                        ...
                        class="inline-flex items-center gap-2 bg-savino-fucsia text-white px-8 py-4 rounded-lg font-bold uppercase tracking-wider text-sm hover:bg-savino-fucsia/90 transition-colors shadow-lg shadow-savino-fucsia/20"
                    >
                        {{ ticketsButtonText }}
