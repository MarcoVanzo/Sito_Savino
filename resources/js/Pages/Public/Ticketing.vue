...
const ogMeta = useOgMeta({
    title: props.page?.title ?? 'Biglietteria',
    description: cd.value.meta_description || 'Acquista i biglietti per le partite della Savino Del Bene Volley al Palazzo Wanny. Abbonamenti e biglietti singoli.',
})
</script>
