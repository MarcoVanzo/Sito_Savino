...
<template>
    <Head :title="page?.title ?? 'Biglietteria'" />
    ...
    <PublicLayout>
        ...
        <section class="relative min-h-[40vh] flex items-center justify-center overflow-hidden">
            ...
            <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
                <span class="text-savino-gold text-sm font-bold uppercase tracking-[0.3em]" style="font-family: 'Montserrat', sans-serif;">Vivi l'Emozione</span>
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-black text-white uppercase tracking-tighter mt-4" style="font-family: 'Montserrat', sans-serif;">{{ page?.title ?? 'Biglietteria' }}</h1>
                <div class="w-16 h-1 bg-savino-gold mx-auto mt-4 mb-6"></div>
                <p class="text-white/70 text-lg max-w-2xl mx-auto" style="font-family: 'Montserrat', sans-serif;">Scegli il tuo posto e vivi l'emozione della pallavolo dal vivo al Palazzo Wanny.</p>
            </div>
        </section>
        ...
        <section class="py-16 bg-gray-50">
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 class="text-3xl font-black text-gray-900 uppercase tracking-tight text-center mb-2" style="font-family: 'Montserrat', sans-serif;">Scegli il tuo Abbonamento</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    >
                        ...
                        <div v-if="plan.highlight" class="absolute top-0 right-0">
                            <div class="bg-savino-gold text-white text-[10px] font-black uppercase tracking-widest px-4 py-1.5 rounded-bl-xl" style="font-family: 'Montserrat', sans-serif;">
                                Più Popolare
                            </div>
                        </div>
                        ...
                        <div class="p-8">
                            ...
                            <div class="flex items-baseline gap-1 mb-6">
                                <span class="text-lg" :class="plan.highlight ? 'text-white/60' : 'text-gray-400'" style="font-family: 'Montserrat', sans-serif;">€</span>
                                <span class="text-5xl font-black" style="font-family: 'Montserrat', sans-serif;">{{ plan.price }}</span>
                                <span class="text-sm" :class="plan.highlight ? 'text-white/60' : 'text-gray-400'" style="font-family: 'Montserrat', sans-serif;">/{{ plan.period }}</span>
                            </div>
        ...
        <section class="py-16 bg-white">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 class="text-3xl font-black text-gray-900 uppercase tracking-tight mb-2" style="font-family: 'Montserrat', sans-serif;">Informazioni sull'Acquisto</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="bg-gray-50 rounded-xl p-6 border border-gray-100">
                        ...
                        <h3 class="text-lg font-bold text-gray-900 mb-2" style="font-family: 'Montserrat', sans-serif;">Online</h3>
                        <p class="text-gray-500 text-sm leading-relaxed" style="font-family: 'Montserrat', sans-serif;">Acquista i biglietti comodamente online tramite il nostro sistema di ticketing. Pagamento sicuro con carta di credito o PayPal.</p>
                    </div>
                    <div class="bg-gray-50 rounded-xl p-6 border border-gray-100">
                        ...
                        <h3 class="text-lg font-bold text-gray-900 mb-2" style="font-family: 'Montserrat', sans-serif;">Al Botteghino</h3>
                        <p class="text-gray-500 text-sm leading-relaxed" style="font-family: 'Montserrat', sans-serif;">La biglietteria del Palazzo Wanny apre 2 ore prima dell'inizio di ogni partita. Accettiamo contanti e pagamenti elettronici.</p>
                    </div>
                </div>
            </div>
        </section>
