...
@section('title', 'Ordine #' . $order->order_number . ' spedito')
...
@section('content')
        ...
        @if($order->tracking_number)
            <tr>
                <td style="padding: 12px 20px; border-bottom: 1px solid #e9ecef;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                            <td style="color: #888888; font-size: 12px; text-transform: uppercase; letter-spacing: 0.5px; font-weight: 600;">Numero Tracking</td>
        ...
        @if($order->shipped_at)
            <tr>
                <td style="padding: 12px 20px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                            <td style="color: #888888; font-size: 12px; text-transform: uppercase; letter-spacing: 0.5px; font-weight: 600;">Data Spedizione</td>
    ...
    <div style="background-color: #E8F4FD; border-left: 4px solid #003063; padding: 16px 20px; margin-bottom: 24px; border-radius: 0 6px 6px 0;">
        <p style="color: #333333; font-size: 14px; margin: 0; line-height: 1.6;">
            <strong>Tempi di consegna stimati:</strong> la spedizione richiede generalmente 2-5 giorni lavorativi, in base alla destinazione.
        </p>
    </div>
        ...
        <tr>
            <td align="center" style="padding: 8px 0 0;">
                <p style="color: #555555; font-size: 14px; margin: 0 0 16px;">
                    Puoi consultare i dettagli del tuo ordine:
                </p>
