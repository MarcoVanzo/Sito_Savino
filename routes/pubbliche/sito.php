...
/**
 * Rotte pubbliche del sito, dentro il gruppo per lingua definito in web.php.
 *
 * Il file gira una volta per lingua: `$loc` e `$namePrefix` arrivano da li'.
 * Sta a parte perche' il gruppo era di duecentocinquanta righe e ci si perdeva
 * fra le sezioni; qui restano le rotte del sito, lo shop e' nel file accanto.
 *
 * @var string $loc
